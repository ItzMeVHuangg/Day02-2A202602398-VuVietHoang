...
```text
Dấu tay rõ nhất của tôi là việc chủ động rút cả 3 bài toán của mình (thủ tục hành chính, bãi xe, chi tiêu) ngay khi thấy chúng phụ thuộc hạ tầng/API bên ngoài mà nhóm không kiểm soát được, giúp nhóm không mất thời gian bảo vệ những bài không khả thi trong lab 4 tiếng và hội tụ nhanh về bài Discord. Đồng thời tập trung xây dựng ý tưởng từ việc sử dụng
```
...
|---|---|---|---|---|
| Scan | Nhờ AI gợi ý thêm problem đời sống/xã hội theo 4 lăng kính sau khi tự scan trước. | Mở rộng góc nhìn sang các mảng tôi chưa nghĩ tới: tra chính sách xã hội, người lớn tuổi dùng app ngân hàng, chờ khám bệnh. | AI đề xuất ý quá rộng kiểu "xây app quản lý toàn bộ cuộc sống cá nhân" — không chỉ ra được bottleneck ở bước nào. | Loại các ý không phải pain thật của tôi/người quen; giữ lại 8 ý có actor rõ và gắn số đo cụ thể (phút/lần, lần/tuần). |
...
```text
Khi nghe top 3 problems của các bạn trong nhóm, tôi nhận ra tiêu chí quan trọng nhất để một bài toán "làm được trong lab 4 tiếng" không phải là bài đó nghe hay hay có vẻ ngầu, mà là nhóm có kiểm chứng được ngay và có quyền truy cập dữ liệu thật hay không. Cả 3 bài của tôi (thủ tục hành chính, bãi xe, chi tiêu cá nhân) đều là pain thật, nhưng khi bị nhóm chất vấn, tôi nhận ra chúng đều phụ thuộc vào hạ tầng hoặc dữ liệu bên ngoài mà nhóm không thể mô phỏng hay kiểm chứng trong buổi lab, giống hệt tình huống của bài Xanh SM mà Duy phải rút vì không có quyền truy cập dữ liệu nội bộ. Ban đầu tôi khá tiếc vì đã đầu tư khá kỹ cho 3 Problem Card của mình, nhưng sau khi nghe bài Discord của Vũ Anh và thấy cả 6 người trong nhóm đều gặp đúng pain đó hàng ngày, tôi hiểu ngay đây mới là bài có thể kiểm chứng bằng dữ liệu thật ngay tại chỗ nên đã chủ động đổi phiếu thay vì cố bảo vệ bài của mình. Nhóm cũng từng có lúc nghiêng về hướng solution-first khi bàn tới việc để AI tự động ghi thẳng task/deadline vào lịch mà không cần xác nhận, nhưng khi tôi và một số bạn đặt câu hỏi "nếu AI hiểu nhầm câu đùa thành deadline gấp thì ai chịu trách nhiệm", nhóm mới quay lại bàn kỹ hơn về ranh giới Human Confirm trước khi ghi lịch. Điều khó nhất với tôi khi làm Problem Card không phải là xác định bottleneck, mà là tìm số đo thật: nhiều problem đời sống tôi quan sát được nhưng chưa từng bấm giờ chính xác, nên phải tự ước lượng dựa trên tần suất và so sánh với thực tế phổ biến thay vì có số liệu đo trực tiếp. Nếu làm lại, tôi sẽ chọn ít nhất một bài toán mà bản thân có thể tự thu thập dữ liệu ngay trong ngày (ví dụ bấm giờ thật khi tìm bãi xe) thay vì chỉ ước lượng, để khi bị nhóm challenge về evidence tôi có bằng chứng chắc chắn hơn.
```
